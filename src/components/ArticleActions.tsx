...
export default function ArticleActions({ title }: ArticleActionsProps) {
  ...
  const githubEditUrl = articleDir
    ? `https://github.com/yukyu30/public_articles/edit/main/source/${articleDir}/index.md`
    : null;
  ...
  return (
    <div className="border-t border-green-400">
      ...
      <div className="border-b border-green-400 px-4 py-2 bg-green-400/10">
        <span className="text-xs font-mono font-bold">&gt; ACTIONS</span>
      </div>
      ...
      <div className="flex">
        ...
        {githubEditUrl && (
          <a
            ...
            className="flex-1 border-r border-green-400 p-4 flex items-center justify-center gap-2 hover:bg-green-400 hover:text-black transition-colors"
          >
            <svg
              className="w-4 h-4"
              fill="currentColor"
        ...
        <button
          ...
          className="flex-1 p-4 flex items-center justify-center gap-2 hover:bg-green-400 hover:text-black transition-colors"
